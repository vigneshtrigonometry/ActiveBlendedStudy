...
var Emoji = {
	...
	trans:  function(text) {
		...
		text = text.replace(Emoji.reg, function (code) {
		    if (code == '83d')
		        return '<img width=' + fontSize + ' class="emoji" style="vertical-align:middle" src="' + Emoji.emojiPath + '1f600' + '.png">';
		    else
		        return '<img width=' + fontSize + ' class="emoji" style="vertical-align:middle" src="' + Emoji.emojiPath + '1f612' + '.png">';
		});
